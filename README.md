...
Almost all of the files are already there when you connect to your username so the only ones you need to create are RIOT one, sensor one and COAP. The sensor, LPS331AP can also measure pressure and i have included it in my main file but for the demonstration only temperature is used. 
